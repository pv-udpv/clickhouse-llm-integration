...
https://github.com/pv-udpv/clickhouse-llm-integration/security/advisories/new

For issues affecting multiple repos in the `pv-udpv` org, use the advisory form
above and list all affected repositories in the report rather than filing a
public issue.
